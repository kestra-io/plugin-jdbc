...
class As400CellConverterTest {

    private As400CellConverter converter() {
        return new As400CellConverter(ZoneId.of("UTC"));
    }

    // convertCell() casts its ResultSet argument to AS400JDBCResultSet, so the mock must
    // actually be that concrete type, not the plain java.sql.ResultSet interface.
    private AS400JDBCResultSet mockResultSet(String columnTypeName, Object data) throws Exception {
        AS400JDBCResultSet rs = mock(AS400JDBCResultSet.class);
    ...
    void testBlob_isMaterializedBeforeResultSetCanClose() throws Exception {
        ...
        AS400JDBCResultSet rs = mockResultSet("blob", blob);
    ...
    void testClob_isMaterializedBeforeResultSetCanClose() throws Exception {
        ...
        AS400JDBCResultSet rs = mockResultSet("clob", clob);
    ...
    void testNClob_isMaterializedBeforeResultSetCanClose() throws Exception {
        ...
        AS400JDBCResultSet rs = mockResultSet("nclob", nclob);
    ...
    void testSqlXml_isMaterializedBeforeResultSetCanClose() throws Exception {
        ...
        AS400JDBCResultSet rs = mockResultSet("xml", sqlxml);
    ...
    void testBlob_nullValueReturnsNull() throws Exception {
        AS400JDBCResultSet rs = mockResultSet("blob", null);
