...
public class ActianVectorTest extends AbstractRdbmsTest {
    ...
    void select() throws Exception {
        ...
        Query task = Query.builder()
            ...
            .sql(Property.ofValue(new String (Files.readAllBytes( Paths.get("src/test/resources/scripts/actianvector.sql")))))
            .build();
