...
@NoArgsConstructor
@Schema(
    title = "Bulk insert rows into Actian Vector using prepared statements",
...
@Plugin(
    aliases = "io.kestra.plugin.jdbc.vectorwise.Batch",
    examples = {
        @Example(
...
public class Batch extends AbstractJdbcBatch implements ActianVectorConnectionInterface {
    @Override
