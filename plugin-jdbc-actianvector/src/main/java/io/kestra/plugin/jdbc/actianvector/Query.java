...
@NoArgsConstructor
@Schema(
    title = "Execute a single SQL query against Actian Vector",
...
@Plugin(
    aliases = "io.kestra.plugin.jdbc.vectorwise.Query",
    examples = {
        @Example(
            title = "Send a SQL query to an Actian Vector database and fetch a row as output.",
            full = true,
            code = """
...
public class Query extends AbstractJdbcQuery implements ActianVectorConnectionInterface {
    @Override
